...
// signing
$response = json_decode(file_get_contents('https://sign.starfiles.co?ipa=' . $ipa_output .'&p12=' . $p12_output . '&mobileprovision=' . $mobileprovision_output . '&password=' . $password), true);
if($response['status'])
